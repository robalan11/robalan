...
\caption[A beam under uniform loading]{This is an image of a beam which is deforming under a uniform load.}
\label{fig:bending}
\end{figure}
...
elements.  Structures such as those in figure \ref{fig:isler_service} can cover a large span with a minimal amount of material and no
internal obstructions.  These structures are very stable because of their unique shape, called a catenary.  See \ref{stability} for
...
a service area, protecting it from the elements with a minimal amount of material.}
...
thin-shell structures providing a much-needed unobstructed internal space.}
...
intended and the building has been plagued with structural problems.}
...
struts to support the huge expanse of the dome.}
...
In order for a building to stand up, the lines of thrust must pass through structural elements.  As can be seen in Figure \ref{fig:arch_lines},
