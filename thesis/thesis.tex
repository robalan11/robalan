...
catenary is not the optimal shape, as seen in Figure \ref{fig:composite_catenary}.

\begin{figure}
\centering
\subfloat[]{
  \label{fig:catenary}
  \includegraphics[width=3in]{images/catenary.png}
}
\subfloat[]{
  \label{fig:hanging_chain}
  \includegraphics[width=3in]{images/hanging_chain.jpg}
}
