...
\label{fig:bending}
\end{figure}
\footnotetext{"Bending", Daniel De Leon Martinez, \url+http://en.wikipedia.org/wiki/File:Bending.png+}
...
\end{figure}
\footnotetext{"Service Area", Heinz Isler, \url+http://commons.wikimedia.org/wiki/File:Deitingen_Sued_Raststaette,_Schalendach_04_09.jpg+}
...
\end{figure}
\footnotetext{"TWA Flight Center", Eero Saarinen, \url+http://en.wikipedia.org/wiki/File:08terminal5.jpg+}
...
\end{figure}
\footnotetext{"Kresge Autidorium", Eero Saarinen, {\url+http://en.wikipedia.org/wiki/File:Kresge_Auditorium,_MIT_\%28view_with_Green_Building\%29.JPG+}}
...
\end{figure}
\footnotetext{"Montreal Biosphere", Richard Buckminster Fuller, \url+http://en.wikipedia.org/wiki/File:Biosphere_montreal.JPG+ FIGURE OUT HOW
TO GET THE BACKSLASH TO GO AWAY FROM IN FRONT OF THE '\%'}
...
\end{figure}
\footnotetext{Screenshot of "Interactive Thrust", John Ochsendorf, \url+http://web.mit.edu/masonry/interactiveThrust/applets/applet01.html+}
...
\end{figure}
\footnotetext{"Gateway Arch", Eero Saarinen, \url+http://en.wikipedia.org/wiki/File:Gateway_Arch.jpg+}
...
\end{figure}
\footnotetext{"Catenary Curves", Geek3, \url+http://en.wikipedia.org/wiki/File:Catenary-pm.svg+}
\footnotetext{"Hanging Chain", Kamel15, \url+http://en.wikipedia.org/wiki/File:Kette_Kettenkurve_Catenary_2008_PD.JPG+}
...
\label{fig:casa_mila}
\end{figure}
\footnotetext{"Casa Mil\`{a}", Antoni Gaud\'{i}, \url+http://en.wikipedia.org/wiki/File:Casa_Mil\%C3\%A0_-_Barcelona,_Spain_-_Jan_2007.jpg+,
\url+http://en.wikipedia.org/wiki/File:LaPedreraParabola.jpg+}
...
\end{figure}
\footnotetext{"Parc Guell", Antoni Gaud\'{i}, \url+http://en.wikipedia.org/wiki/File:Parcguell.jpg+,
\url+http://en.wikipedia.org/wiki/File:Parc_Guell_10.jpg+}
...
\end{figure}
\footnotetext{"Sagrada Fam\'{i}lia", Antoni Gaud\'{i}, \url+http://en.wikipedia.org/wiki/File:Sagradafamilia-overview.jpg+,
...
\end{figure}
\footnotetext{"Hanging model", Antoni Gaud\'{i}, \url+http://2.bp.blogspot.com/_PZOVPTsrTJ0/SR7z2F_h93I/AAAAAAAAAls/hAv1--bslzQ/s1600-h/Gaudi+model.jpg+}
